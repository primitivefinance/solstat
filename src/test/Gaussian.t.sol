...
contract TestGaussian is Test {
    ...
    function test_ppf() public {
        assertApproxEqRel(
            Gaussian.ppf(0.5 ether),
            int256(0 ether),
            CDF_ERROR_REL,
            "ppf-0.5"
        );
        assertApproxEqRel(
            Gaussian.ppf(0.99 ether),
            int256(2.3263478740408411 ether),
            CDF_ERROR_REL,
            "ppf-0.99"
        );
        assertApproxEqRel(
            Gaussian.ppf(0.01 ether),
            -int256(2.3263478740408411 ether),
            CDF_ERROR_REL,
            "ppf-0.01"
        );
        assertApproxEqRel(
            Gaussian.ppf(0.999999 ether),
            int256(4.75342430882289895 ether),
            CDF_ERROR_REL,
            "ppf-0.999999"
        );
        assertApproxEqRel(
            Gaussian.ppf(0.000001 ether),
